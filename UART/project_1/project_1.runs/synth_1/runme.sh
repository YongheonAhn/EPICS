...
HD_PWD='E:/Dropbox/yongheon/Research/phoebus/EPICS/UART/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_uart_lcd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_uart_lcd.tcl
