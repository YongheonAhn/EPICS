...
HD_PWD='E:/Dropbox/yongheon/Research/phoebus/EPICS/UART/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_uart_lcd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_uart_lcd.tcl -notrace
