...
HD_PWD='E:/Dropbox/yongheon/Research/phoebus/EPICS/UART/PRINT_7SEG/PRINT_7SEG.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_uart_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_uart_display.tcl -notrace
