...
HD_PWD='E:/Dropbox/yongheon/Research/phoebus/EPICS/UART/PRINT_7SEG/PRINT_7SEG.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_uart_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_uart_display.tcl
